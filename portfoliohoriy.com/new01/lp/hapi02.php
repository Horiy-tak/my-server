      ...
      <article class="article">
        <div class="article-container">
          <div class="underlayer_title">
            <h2 class="article-title">株式会社ハピエス様</h2>
            <p>不動産投資｜賃貸併用住宅LP</p>
          </div>
          <div class="article-body">
            <p>
              <img src="/img/lp/detail/hapi02.jpg" alt="">
            </p>
            <!--    <h3>URL</h3>
            <p><a href="XXXXXXXX" target="_blank" rel="noopener">XXXXXXXX</a></p>-->
            <h3>サイトの目的｜意図・方向性</h3>
            <p>不動産投資検討層ではなく、一般の住宅購入検討層に向けたLP。
              住宅購入と資産形成が同時にできるという利点を活かして、住宅購入の新しい選択肢を提示。
              投資・資産形成ニーズの高まりに合わせた現役世代向けのLPとしました。
            </p>
            <h3>ターゲット</h3>
            <p>都心部での住宅購入を検討している世帯年収700万円からの子育て世代。</p>
            <!--  <h3>担当</h3>
            <p>デザイン・コーディング</p> -->
            <!--<h3>デザインについて</h3>
            <p>
