...
<head>
  ...
  <meta property='og:title' content='Web ディレクターTAKAHIRO HORIGOME ポートフォリオ'>
      ...
      <article class="article">
        <div class="article-container">
          <div class="underlayer_title">
            <h2 class="article-title">株式会社東京スター銀行様</h2>
            <p>外貨預金キャンペーンLP</p>
          </div>
          <div class="article-body">
            <p>
              <img src="/img/lp/detail/tsb_foreign.jpg" alt="">
            </p>
            <!-- <h3>URL</h3>
            <p><a href="XXXXXXXXXXx" target="_blank" rel="noopener">XXXXXXXXXXx</a></p> -->
            <h3>サイトの目的｜意図・方向性</h3>
            <p>円安ドル高に合わせて作成した外貨預金キャンペーンLP。
              前提として『外貨預金』のリテラシーがある程度ある層をターゲットとしているため、細かな外貨預金の説明は省き、当行の強みとオファーを前面に押し出した内容となっています。<br>
              また、金利部分は毎月更新する前提で構築しています。
            </p>
            <h3>ターゲット</h3>
            <p>外貨預金の知識・経験があり、金融機関を比較検討している層。</p>
            <!--  <h3>担当</h3>
            <p>デザイン・コーディング</p> -->
            <!--<h3>デザインについて</h3>
            <p>
              テキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入ります。<br>テキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入ります。テキストが入りますテキストが入りますテキストが入りますテキストが入りますテキストが入ります
            </p>
            <p>
