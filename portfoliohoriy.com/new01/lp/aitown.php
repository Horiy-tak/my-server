      ...
      <article class="article">
        <div class="article-container">
          <div class="underlayer_title">
            <h2 class="article-title">株式会社アイダ設計様</h2>
            <p>セミオーダー住宅資料請求LP</p>
          </div>
          <div class="article-body">
            <p>
              <img src="/img/lp/detail/aitown.jpg" alt="">
            </p>
            <!--  <h3>URL</h3>
            <p><a href="https://yahoo.co.jp" target="_blank" rel="noopener">https://yahoo.co.jp</a></p> -->
            <h3>サイトの目的｜意図・方向性</h3>
            <p>分譲住宅という商材の特性上、単一ページであるLPでの集客が難しい課題でしたが、<br>
              KPIは資料請求をメインに置き、物件ではなくサービスその物の良さを伝える事をコンセプトとしました。
            </p>
            <h3>ターゲット</h3>
            <p>分譲住宅を検討しており情報収集を行っているユーザー。</p>
            <!--  <h3>担当</h3>
            <p>デザイン・コーディング</p> -->
            <!--<h3>デザインについて</h3>
            <p>
